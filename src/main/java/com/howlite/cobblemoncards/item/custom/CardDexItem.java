...
public class CardDexItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide() && player instanceof ServerPlayer serverPlayer) {
            ...
            List<String> discovered = serverPlayer.getAttachedOrCreate(PlayerDataAttachments.DISCOVERED_CARDS, ArrayList::new);
            ...
            ServerPlayNetworking.send(serverPlayer, new SyncDiscoveredCardsPayload(discovered));
        }
