...
public class ModItems {
    ...
    public static final Item CARD = new CardItem(new Item.Properties().stacksTo(1));

    // Nouveaux Binders
    public static final Item LEATHER_BINDER = new BinderItem(BinderTier.LEATHER, new Item.Properties().stacksTo(1));
    public static final Item IRON_BINDER = new BinderItem(BinderTier.IRON, new Item.Properties().stacksTo(1));
    public static final Item GOLD_BINDER = new BinderItem(BinderTier.GOLD, new Item.Properties().stacksTo(1));
    public static final Item DIAMOND_BINDER = new BinderItem(BinderTier.DIAMOND, new Item.Properties().stacksTo(1));
    public static final Item NETHERITE_BINDER = new BinderItem(BinderTier.NETHERITE, new Item.Properties().stacksTo(1).fireResistant());
    public static final Item MASTER_ALBUM = new MasterAlbumItem(new Item.Properties().stacksTo(1));
