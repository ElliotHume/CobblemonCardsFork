...
public class CardAdvancementManager {
    ...
    public static void checkAdvancements(ServerPlayer player) {
        ...
        java.util.List<String> discovered = new java.util.ArrayList<>(player.getAttachedOrCreate(PlayerDataAttachments.DISCOVERED_CARDS, java.util.ArrayList::new));
        ...
        if (discoveredChanged) {
            player.setAttached(PlayerDataAttachments.DISCOVERED_CARDS, discovered);
        }
    ...
    public static void trackBoosterOpening(ServerPlayer player) {
        ...
        int currentCount = player.getAttachedOrCreate(PlayerDataAttachments.OPENED_BOOSTERS, () -> 0);
        currentCount++;
        player.setAttached(PlayerDataAttachments.OPENED_BOOSTERS, currentCount);
