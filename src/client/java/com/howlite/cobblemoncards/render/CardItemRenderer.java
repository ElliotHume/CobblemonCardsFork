...
public class CardItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    ...
    private boolean isProceduralEffect(String effect) {
    ...
    private String getBaseSpeciesName(String name) {
    ...
    private String sanitizeStandardPath(String id) {
    ...
    private String sanitizeEntityIconPath(String id) {
        if (id == null) return "missing";
        return id.toLowerCase()
                 .replace(".", "")
                 .replace(" ", "")
    ...
    private String getRemappedEntityName(String cleanName) {
    ...
    private void renderProceduralBackgroundShader(PoseStack matrices, MultiBufferSource vertexConsumers, String bgType, int light, int overlay, float w, float h) {
        Matrix4f matrix = matrices.last().pose();
    ...
    private void renderProceduralEffectShader(PoseStack matrices, MultiBufferSource vertexConsumers, String effectType, int light, int overlay, float w, float h) {
        Matrix4f matrix = matrices.last().pose();
    ...
    private int getBackgroundEffectId(String bgType) {
    ...
    private int getHoloEffectId(String effectType) {
